...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('portfolio_datasource', (
            ...
            ('document_completeness', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('document_freshness', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('data_source_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portfolio.DataSourceType'])),
            ('hardware_platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portfolio.HardwarePlatform'], null=True, blank=True)),
            ('data_volume', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('maximum_capacity', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('annual_data_volume_growth', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
        ))
        db.send_create_signal('portfolio', ['DataSource'])

        # Adding model 'Vendor'
        db.create_table('portfolio_vendor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('portfolio', ['Vendor'])

        # Adding model 'HardwarePlatform'
        db.create_table('portfolio_hardwareplatform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portfolio.Vendor'])),
        ))
        db.send_create_signal('portfolio', ['HardwarePlatform'])

        # Adding model 'DataSourceType'
        db.create_table('portfolio_datasourcetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portfolio.Vendor'])),
        ))
        db.send_create_signal('portfolio', ['DataSourceType'])


    def backwards(self, orm):
        
        # Deleting model 'DataSource'
        db.delete_table('portfolio_datasource')

        # Deleting model 'Vendor'
        db.delete_table('portfolio_vendor')

        # Deleting model 'HardwarePlatform'
        db.delete_table('portfolio_hardwareplatform')

        # Deleting model 'DataSourceType'
        db.delete_table('portfolio_datasourcetype')
