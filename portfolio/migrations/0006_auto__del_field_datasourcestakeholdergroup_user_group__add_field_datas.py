...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataSourceStakeholderGroup.stakeholder_group'
        db.add_column('portfolio_datasourcestakeholdergroup', 'stakeholder_group', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['portfolio.StakeholderGroup']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DataSourceStakeholderGroup.stakeholder_group'
        db.delete_column('portfolio_datasourcestakeholdergroup', 'stakeholder_group_id')
    ...
    models = {
        ...
        'portfolio.datasourcestakeholdergroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'stakeholder_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['portfolio.StakeholderGroup']"}),
